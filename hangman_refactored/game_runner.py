...
class GameRunner:
    ...
    Attributes:
        game (HangmanGame): The current game instance (HangmanGame or WordleGame)
    ...
    def _process_args(self) -> tuple[GameType, int | None, str | None]:
        ...
        if pathlib.Path.is_file(HangmanGame.RESTORE_FILE_PATH):
